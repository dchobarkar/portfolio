...
const Glitch = styled.div`
  ${glitchAnimation('2s')};
  left: -2px;
  text-shadow: 2px 0 #f9f8f8, -1px 0 cyan, -2px 0 green,
...
const FourOhFour = () => {
  ...
  return (
    <div
      className="absolute bg-white font-title w-full h-full top-0 left-0 -translate-y-1/2 overflow-hidden"
      role="main"
    >
      <div>
        ...
        <Glitch className="glitch absolute w-full top-0 overflow-hidden">
          <Title className="relative font-title font-extrabold text-base-300 leading-none text-center uppercase mt-18 mb-10 cursor-default">
            404
          </Title>
        </Glitch>
      </div>
